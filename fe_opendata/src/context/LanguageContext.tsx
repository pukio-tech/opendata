...
export const translations = {
  ES: {
    ...
    'terms.heroDesc': 'OpenData Perú es un portal de consulta pública y libre acceso que visualiza información oficial del Inventario Nacional de Recursos Turísticos (MINCETUR), Directorio Oficial de Empresas (Plataforma Nacional de Datos Abiertos - Gob.pe) y la Ruta del Papa León XIV (IRTP / Presidencia) sin manipulación de datos ni recolección de información personal.',
    'terms.s1Title': 'Origen Oficial de las Fuentes de Información',
    'terms.s1Desc1': 'Todos los datos, fichas técnicas, registros empresariales, códigos de ubigeo, cronogramas de actividades, descripciones y coordenadas geográficas mostradas en este portal son recopilados directamente desde plataformas y fuentes públicas oficiales del Estado Peruano.',
    'terms.s1Desc2': 'Las entidades públicas rectoras correspondientes son las titulares originales y custodias de las respectivas bases de datos abiertas del Perú.',
