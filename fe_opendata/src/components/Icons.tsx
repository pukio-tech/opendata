...
export const Icons = {
  ...
  Waves: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
  ...
  Trees: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10 10v.2A3 3 0 0 1 8.9 16H5a3 3 0 0 1-1-5.8V10a3 3 0 0 1 6 0zM7 16v6M13 19v3M12 19h8.3a1 1 0 0 0 .7-1.7L18 14h.3a1 1 0 0 0 .7-1.7L16 9h.2a1 1 0 0 0 .8-1.7L13 3l-4 4.3a1 1 0 0 0 .8 1.7H10l-3 3.3a1 1 0 0 0 .7 1.7H8l-3 3.3a1 1 0 0 0 .7 1.7H12" />
    </svg>
  ),
  Footprints: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v-2.38C4 11.5 2.97 8.1 4.5 5.5A4.5 4.5 0 0 1 8.5 3c2.3 0 3.5 1.7 3.5 3.5 0 1.5-.8 3-2 4.5L8 16a2 2 0 0 1-4 0zM16 8v2.38c0 2.12 1.03 5.52-.5 8.12a4.5 4.5 0 0 1-4 2.5c-2.3 0-3.5-1.7-3.5-3.5 0-1.5.8-3 2-4.5L12 8a2 2 0 0 1 4 0z" />
    </svg>
  ),
  ...
  Minimize: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 14h6m0 0v6m0-6-7 7m17-11h-6m0 0V4m0 6 7-7" />
    </svg>
  ),
  ...
  Navigation: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
  ...
  WhatsApp: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12.031 0C5.396 0 .029 5.367.029 12.002c0 2.12.554 4.188 1.603 6.01L0 24l6.177-1.62a11.93 11.93 0 0 0 5.854 1.52h.005c6.635 0 12.001-5.367 12.001-12.002C24.037 5.367 18.666 0 12.031 0zm-.005 21.879h-.004a9.92 9.92 0 0 1-5.06-1.39l-.363-.215-3.76.986 1.003-3.666-.236-.375a9.932 9.932 0 0 1-1.523-5.217c0-5.485 4.463-9.948 9.95-9.948 2.658 0 5.158 1.036 7.037 2.915 1.88 1.88 2.915 4.38 2.914 7.04-.002 5.487-4.465 9.95-9.954 9.95zm5.454-7.447c-.299-.15-1.77-.874-2.044-.974-.274-.1-.473-.15-.672.15-.2.299-.772.973-.946 1.173-.174.2-.349.225-.648.075-.3-.15-1.266-.467-2.41-1.488-.89-.794-1.492-1.776-1.666-2.075-.175-.3-.019-.462.131-.611.135-.134.299-.349.449-.524.15-.175.2-.299.3-.499.1-.2.05-.374-.025-.524-.075-.15-.672-1.62-.921-2.22-.242-.583-.487-.504-.672-.513-.174-.008-.373-.01-.573-.01-.2 0-.523.075-.797.374-.274.3-1.046 1.023-1.046 2.494 0 1.472 1.071 2.894 1.221 3.093.15.2 2.108 3.218 5.107 4.513.713.309 1.27.493 1.704.631.716.228 1.368.196 1.883.119.575-.086 1.77-.723 2.02-1.422.25-.698.25-1.297.174-1.422-.075-.125-.274-.2-.573-.349z" />
    </svg>
  ),
  ...
  Car: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 17h14M5 17a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2M5 17l-1 2h2l1-2m11 0 1 2h2l-1-2M7 11h.01M17 11h.01" />
    </svg>
  ),
  Bus: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <rect x="4" y="3" width="16" height="16" rx="2" />
      <path d="M4 11h16M8 15h.01M16 15h.01M6 19v2M18 19v2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  ...
  Star: ({ className = 'w-5 h-5', fill }: { className?: string; fill?: string }) => (
    <svg className={className} fill={fill || 'currentColor'} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
  ...
  ShieldCheck: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
  ...
  Briefcase: ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.25v4.5a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25v-4.5m16.5 0v-4.5a2.25 2.25 0 0 0-2.25-2.25h-2.25m-12 6.75v-4.5A2.25 2.25 0 0 1 6 7.5h2.25m12 6.75a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25m12 0H6m6-6.75v-2.25A2.25 2.25 0 0 0 9.75 3h-1.5A2.25 2.25 0 0 0 6 5.25v2.25" />
    </svg>
  ),
