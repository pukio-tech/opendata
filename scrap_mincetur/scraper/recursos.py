...
class RecursosScraper:
    ...
    def scrape_and_save_all(self) -> Dict[str, Any]:
        ...
        logger.info(f"✅ Catálogo de recursos guardado ({len(recursos)} recursos activos en total, distribuidos en {len(por_dpto)} departamentos).")
        return {
            "total_recursos": len(recursos),
            "departamentos_generados": len(por_dpto),
        }
